...
//        List<Product> product = factory.getInvoices();
//        for (Product product : products) {
//            app.createPdf(product);
//        }
//        factory.close();
//    }
//    
//    public ProductController() throws DocumentException, IOException {
...
//    }
//    
//    public void createPdf(Product product) throws ParserConfigurationException, SAXException, TransformerException, IOException, DocumentException, XMPException, ParseException {
//        String dest = String.format(DEST, product.getId());
